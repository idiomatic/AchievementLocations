...
A{"Arathi", 6586, 0.3900, 0.8900, criterion=21611, note="zone exclusive"} -- Grasslands Cottontail
A{"Arathi", 6586, 0.3900, 0.8900, criterion=21613, note="more common in Durotar"} -- Prairie Dog
...
A{"Ashenvale", 6585, 0.7000, 0.6000, criterion=21691, note="zone exclusive"} -- Frog
A{"Ashenvale", 6585, 0.1300, 0.2700, criterion=21703, note="zone exclusive"} -- Rusty Snail

-- Pet Battles: Taming Kalimdor
A{"Ashenvale", 6602, 0.2000, 0.3000, criterion=21404, side="horde"} -- Analynn

-- Pet Battles/Collect: Kalimdor Tamer
A{"Ashenvale", 6612, criterion=21448} -- Ashenvale

-- Pet Battles: The Longest Day
A{"Ashenvale", 8348, 0.2000, 0.3000, criterion=23456} -- Analynn
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"Badlands", 6586, 0.7000, 0.4600, criterion=21616} -- Gold Beetle
A{"Badlands", 6586, criterion=21617} -- Rattlesnake
A{"Badlands", 6586, 0.5900, 0.2000, criterion=21618, note="zone exclusive"} -- King Snake
A{"Badlands", 6586, 0.7000, 0.4600, criterion=21619} -- Spiky Lizard
A{"Badlands", 6586, 0.7000, 0.4600, criterion=21620} -- Stripe-Tailed Scorpid
...
-- Pet Battles: Taming Kalimdor
A{"Barrens", 6602, 0.5900, 0.5300, criterion=21403, side="horde"} -- Dagra the Fierce

-- Pet Battles/Collect: Kalimdor Tamer
A{"Barrens", 6612, criterion=21460} -- Northern Barrens

-- Pet Battles: The Longest Day
A{"Barrens", 8348, 0.5900, 0.5300, criterion=23455} -- Dagra the Fierce
...
-- Pet Battles/Collect: Kalimdor Safari
A{"BlastedLands", 6585, 0.6000, 0.6100, criterion=21623, note="zone exclusive"} -- Scorpling

-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"BlastedLands", 6586, 0.4400, 0.2600, criterion=21509} -- Adder
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"BurningSteppes", 6586, 0.1900, 0.6500, criterion=21624} -- Ash Viper
A{"BurningSteppes", 6586, 0.3600, 0.5300, criterion=21626, note="zone exclusive"} -- Lava Beetle

-- Pet Battles: Taming Eastern Kingdoms
A{"BurningSteppes", 6603, 0.2600, 0.4800, criterion=21603, note="At the bottom of the ramp to Blackrock Mountain Pet Level: 17", side="alliance"} -- Durin Darkhammer

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"BurningSteppes", 6613, criterion=21423} -- Burning Steppes

-- Pet Battles: The Longest Day
A{"BurningSteppes", 8348, 0.2600, 0.4800, criterion=23451} -- Durin Darkhammer

-- Pet Battles/Collect: So. Many. Pets.
A{"BurningSteppes", 9643, criterion="Tiny Flamefly"} -- Tiny Flamefly

-- Pet Battles: Taming Northrend
A{"CrystalsongForest", 6605, 0.5000, 0.5900, criterion=21849} -- Nearly Headless Jacob

-- Pet Battles/Collect: Northrend Tamer
A{"CrystalsongForest", 6615, criterion=21478} -- Crystalsong Forest

-- Pet Battles: The Longest Day
A{"CrystalsongForest", 8348, 0.5000, 0.5900, criterion=23480} -- Nearly Headless Jacob

-- Pet Battles/Battle: An Awfully Big Adventure
A{"CrystalsongForest", 9069, 0.5020, 0.5900, criterion=26993} -- Nearly Headless Jacob

-- Pet Battles/Collect: Crazy for Cats
A{"Dalaran", 8397, 0.5900, 0.4000, criterion=23579, note="from Breanni"} -- Calico Cat
A{"DarkmoonFaireIsland", 8397, 0.4900, 0.7000, criterion=23583, note="from Lhara of Darkmoon Faire"} -- Darkmoon Cub

-- Pet Battles/Battle: An Awfully Big Adventure
A{"DarkmoonFaireIsland", 9069, criterion=26976} -- Christoph VonFeasel
A{"DarkmoonFaireIsland", 9069, 0.4780, 0.6260, criterion=26986} -- Jeremy Feasel
...
-- Pet Battles/Collect: Kalimdor Safari
A{"Darkshore", 6585, 0.4300, 0.8000, criterion=21697, note="zone exclusive"} -- Darkshore Cub
...
-- Pet Battles: Taming Eastern Kingdoms
A{"DeadwindPass", 6603, 0.4000, 0.7600, criterion=21602, side="alliance"} -- Lydia Accoste

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"DeadwindPass", 6613, criterion=21428} -- Deadwind Pass

-- Pet Battles: The Longest Day
A{"DeadwindPass", 8348, 0.4000, 0.7600, criterion=23452} -- Grand Master Lydia Accoste

-- Pet Battles/Battle: An Awfully Big Adventure
A{"DeadwindPass", 9069, 0.4020, 0.7640, criterion=26988} -- Lydia Accoste
...
A{"Deepholm", 7525, 0.5000, 0.5700, criterion=21859} -- Bordin Steadyfist

-- Pet Battles: The Longest Day
A{"Deepholm", 8348, 0.5000, 0.5700, criterion=23484} -- Bordin Steadyfist

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Deepholm", 9069, 0.4980, 0.5700, criterion=26972} -- Bordin Steadyfist
...
-- Pet Battles: Taming Kalimdor
A{"Desolace", 6602, 0.5700, 0.4600, criterion=21406, side="horde"} -- Merda Stronghoof

-- Pet Battles/Collect: Kalimdor Tamer
A{"Desolace", 6612, criterion=21453} -- Desolace

-- Pet Battles: The Longest Day
A{"Desolace", 8348, 0.5700, 0.4600, criterion=23459} -- Merda Stronghoof
...
-- Pet Battles: Taming Northrend
A{"Dragonblight", 6605, 0.5900, 0.7700, criterion=21850} -- Okrut Dragonwaste

-- Pet Battles/Collect: Northrend Tamer
A{"Dragonblight", 6615, criterion=21479} -- Dragonblight

-- Pet Battles: The Longest Day
A{"Dragonblight", 8348, 0.5900, 0.7700, criterion=23479} -- Okrut Dragonwaste

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Dragonblight", 9069, 0.5900, 0.7700, criterion=26996} -- Okrut Dragonwaste
...
A{"DreadWastes", 6606, 0.5500, 0.3700, criterion=21856} -- Wastewalker Shu

-- Pet Battles/Collect: Pandaria Tamer
A{"DreadWastes", 6616, criterion=21494} -- Dread Wastes

-- Pet Battles: The Longest Day
A{"DreadWastes", 8348, 0.5500, 0.3700, criterion=23492} -- Grand Master Shu
A{"DreadWastes", 8348, 0.6100, 0.8800, criterion=23494} -- Flowing Pandaren Spirit
A{"DreadWastes", 8348, 0.2600, 0.5000, criterion=23500, note="[3 beasts]"} -- Gorespine

-- Pet Battles/Battle: An Awfully Big Adventure
A{"DreadWastes", 9069, 0.6120, 0.8760, criterion=26981} -- Flowing Pandaren Spirit
A{"DreadWastes", 9069, 0.5500, 0.3740, criterion=27007} -- Wastewalker Shu
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"DunMorogh", 6586, 0.5800, 0.3600, criterion=21510} -- Alpine Hare
A{"DunMorogh", 6586, 0.2800, 0.3400, criterion=21507, note="zone exclusive"} -- Irradiated Roach
A{"DunMorogh", 6586, 0.3200, 0.7800, criterion=21516} -- Rat
A{"DunMorogh", 6586, 0.5800, 0.3600, criterion=21520, note="zone exclusive"} -- Snow Cub
...
A{"DunMorogh", 8397, 0.2800, 0.3500, criterion=23585} -- Fluxfire Feline
...
-- Pet Battles: Taming Kalimdor
A{"Durotar", 6602, 0.4400, 0.2900, criterion=21402, side="horde"} -- Zunta

-- Pet Battles/Collect: Kalimdor Tamer
A{"Durotar", 6612, criterion=21454} -- Durotar

-- Pet Battles: The Longest Day
A{"Durotar", 8348, 0.4400, 0.2900, criterion=23454} -- Zunta
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"Duskwood", 6586, 0.1900, 0.4100, criterion=21511} -- Black Rat
A{"Duskwood", 6586, 0.5600, 0.1600, criterion=21630, note="zone exclusive"} -- Dusk Spiderling
A{"Duskwood", 6586, 0.7400, 0.4700, criterion=21629, note="south of Darkshire in the fields"} -- Chicken
...
A{"Duskwood", 6586, 0.7400, 0.4700, criterion=21631, note="around the town square"} -- Mouse
A{"Duskwood", 6586, 0.5600, 0.1600, criterion=21633} -- Skunk
...
-- Pet Battles: Taming Eastern Kingdoms
A{"Duskwood", 6603, 0.2000, 0.4500, criterion=21399, note="Next to the statue. Pet Level: 7", side="alliance"} -- Eric Davidson

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"Duskwood", 6613, criterion=21386} -- Duskwood

-- Pet Battles: The Longest Day
A{"Duskwood", 8348, 0.2000, 0.4500, criterion=23444} -- Eric Davidson
...
-- Pet Battles: Taming Kalimdor
A{"Dustwallow", 6602, 0.5400, 0.7500, criterion=21410, side="horde"} -- Grazzle the Great

-- Pet Battles/Collect: Kalimdor Tamer
A{"Dustwallow", 6612, criterion=21455} -- Dustwallow Marsh

-- Pet Battles: The Longest Day
A{"Dustwallow", 8348, 0.5400, 0.7500, criterion=23461} -- Grazzle the Great
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"EasternPlaguelands", 6586, 0.3500, 0.6800, criterion=21622, note="common second pet from here to the end of the zone"} -- Scorpid
A{"EasternPlaguelands", 6586, 0.0700, 0.6400, criterion=21635} -- Bat
A{"EasternPlaguelands", 6586, 0.3400, 0.8300, criterion=21636, note="zone exclusive"} -- Festering Maggot
A{"EasternPlaguelands", 6586, 0.0700, 0.6400, criterion=21638} -- Infected Squirrel

-- Pet Battles: Taming Eastern Kingdoms
A{"EasternPlaguelands", 6603, 0.6700, 0.5200, criterion=21599, note="on the northeast bank of the lake.  Pet level: 14", side="alliance"} -- Deiza Plaguehorn

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"EasternPlaguelands", 6613, criterion=21430} -- Eastern Plaguelands

-- Pet Battles: The Longest Day
A{"EasternPlaguelands", 8348, 0.6700, 0.5200, criterion=23448} -- Deiza Plaguehorn
...
A{"Elwynn", 6586, 0.2400, 0.7600, criterion=21518} -- Small Frog
A{"Elwynn", 6586, criterion=21522} -- Squirrel
A{"Elwynn", 6586, 0.4200, 0.6500, criterion=21610, note="around Donni Anthania's house"} -- Cat
A{"Elwynn", 6586, 0.4200, 0.6500, criterion=21639, note="in between Donnia Anthania's house and Goldshire"} -- Fawn
...
-- Pet Battles: Taming Eastern Kingdoms
A{"Elwynn", 6603, 0.4200, 0.8400, criterion=21396, note="North-east corner. Pet Level 2", side="alliance"} -- Julia Stevens

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"Elwynn", 6613, criterion=21380} -- Elwynn Forest

-- Pet Battles: The Longest Day
A{"Elwynn", 8348, 0.4200, 0.8400, criterion=23418} -- Julia Stevens

-- Pet Battles/Collect: Crazy for Cats
A{"Elwynn", 8397, 0.4400, 0.5300, criterion=23578, note="from Donni Anthania"} -- Bombay Cat
A{"Elwynn", 8397, criterion=23580} -- Cat
A{"Elwynn", 8397, 0.4400, 0.5300, criterion=23582, note="from Donni Anthania"} -- Cornish Rex Cat
A{"Elwynn", 8397, 0.3200, 0.5000, criterion=23584, note="from Dorothy during Hallow's End"} -- Feline Familiar
A{"Elwynn", 8397, 0.4400, 0.5300, criterion=23587, note="from Donni Anthania"} -- Orange Tabby Cat
A{"Elwynn", 8397, 0.4400, 0.5300, criterion=23592, note="from Donni Anthania"} -- Silver Tabby Cat

-- Pet Battles/Collect: So. Many. Pets.
A{"Elwynn", 9643, criterion="Black Lamb"} -- Black Lamb
A{"Elwynn", 9643, 0.4200, 0.6500, criterion="Cat Carrier (Bombay)", note="from Donni Anthania"} -- Cat Carrier (Bombay)
A{"Elwynn", 9643, 0.4200, 0.6500, criterion="Cat Carrier (Cornish Rex)", note="from Donni Anthania"} -- Cat Carrier (Cornish Rex)
A{"Elwynn", 9643, 0.4200, 0.6500, criterion="Cat Carrier (Orange Tabby)", note="from Donni Anthania"} -- Cat Carrier (Orange Tabby)
A{"Elwynn", 9643, 0.4200, 0.6500, criterion="Cat Carrier (Silver Tabby)", note="from Donni Anthania"} -- Cat Carrier (Silver Tabby)
A{"Elwynn", 9643, 0.4200, 0.6500, criterion="Cat", note="around Donni Anthania"} -- Cat
...
-- Pet Battles/Collect: Kalimdor Safari
A{"Felwood", 6585, 0.4500, 0.4200, criterion=21722, note="zone exclusive"} -- Minfernal
...
-- Pet Battles: Taming Kalimdor
A{"Felwood", 6602, 0.4000, 0.5700, criterion=21411, side="horde"} -- Zoltan

-- Pet Battles/Collect: Kalimdor Tamer
A{"Felwood", 6612, criterion=21456} -- Felwood

-- Pet Battles: The Longest Day
A{"Felwood", 8348, 0.4000, 0.5700, criterion=23463} -- Zoltan
...
-- Pet Battles/Collect: Kalimdor Safari
A{"Feralas", 6585, 0.6400, 0.3400, criterion=21726, note="zone exclusive"} -- Nether Faerie Dragon

-- Pet Battles: Taming Kalimdor
A{"Feralas", 6602, 0.6000, 0.5000, criterion=21407, side="horde"} -- Traitor Gluk

-- Pet Battles/Collect: Kalimdor Tamer
A{"Feralas", 6612, criterion=21457} -- Feralas

-- Pet Battles: The Longest Day
A{"Feralas", 8348, 0.6000, 0.5000, criterion=23458} -- Traitor Gluk

-- Pet Battles/Battle: An Awfully Big Adventure
A{"FrostfireRidge", 9069, 0.6860, 0.6460, criterion=26982} -- Gargra
...
A{"FrostfireRidge", 9724, 0.6860, 0.6480, criterion=27013} -- Gargra
...
-- Pet Battles/Battle: An Awfully Big Adventure
A{"Gorgrond", 9069, 0.5100, 0.7060, criterion=26978} -- Cymre Brightblade
...
-- Pet Battles: Taming Draenor
A{"Gorgrond", 9724, 0.5100, 0.7100, criterion=27011} -- Cymre Brightblade
...
A{"Hellfire", 6604, 0.6400, 0.4900, criterion=21604} -- Nicki Tinytech

-- Pet Battles/Collect: Outland Tamer
A{"Hellfire", 6614, criterion=21469} -- Hellfire Peninsula

-- Pet Battles: The Longest Day
A{"Hellfire", 8348, 0.6400, 0.4900, criterion=23473} -- Nicki Tinytech

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Hellfire", 9069, 0.6440, 0.4920, criterion=26994} -- Nicki Tinytech
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"HillsbradFoothills", 6586, 0.5500, 0.4700, criterion=21514, note="also in Southshore Ruins and The Sludge Fields"} -- Maggot
A{"HillsbradFoothills", 6586, 0.3500, 0.4700, criterion=21521, note="inside the mine"} -- Spider
...
A{"HillsbradFoothills", 6586, 0.6200, 0.8400, criterion=21651} -- Red-Tailed Chipmunk
...
A{"HillsbradFoothills", 9643, 0.3400, 0.7400, criterion="Brazie's Sunflower Seeds", item="51090", note="from Lawn of the Dead"} -- Brazie's Sunflower Seeds
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"Hinterlands", 6586, 0.1200, 0.4600, criterion=21612} -- Hare
...
-- Pet Battles: Taming Eastern Kingdoms
A{"Hinterlands", 6603, 0.6300, 0.5500, criterion=21598, note="between Stormfeather & Jinth'alor Pet Level: 13", side="alliance"} -- David Kosse

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"Hinterlands", 6613, criterion=21437} -- Hinterlands

-- Pet Battles: The Longest Day
A{"Hinterlands", 8348, 0.6300, 0.5500, criterion=23447} -- David Kosse
...
-- Pet Battles: Taming Northrend
A{"HowlingFjord", 6605, 0.2700, 0.3400, criterion=21848} -- Beegle Blastfuse

-- Pet Battles/Collect: Northrend Tamer
A{"HowlingFjord", 6615, criterion=21481} -- Howling Fjord

-- Pet Battles: The Longest Day
A{"HowlingFjord", 8348, 0.2700, 0.3400, criterion=23481} -- Beegle Blastfuse

-- Pet Battles/Battle: An Awfully Big Adventure
A{"HowlingFjord", 9069, 0.2860, 0.3380, criterion=26970} -- Beegle Blastfuse
...
-- Pet Battles/Collect: Kalimdor Safari
A{"Hyjal", 6585, 0.3100, 0.7800, criterion=21730, note="zone exclusive"} -- Carrion Rat
A{"Hyjal", 6585, 0.2700, 0.3900, criterion=21731, note="zone exclusive"} -- Death's Head Cockroach
A{"Hyjal", 6585, criterion=21732} -- Fire-Proof Roach
A{"Hyjal", 6585, 0.6200, 0.2300, criterion=21734, note="zone exclusive"} -- Nordrassil Wisp

-- Pet Battles/Collect: Kalimdor Tamer
A{"Hyjal", 6612, criterion=21488} -- Mount Hyjal

-- Pet Battles: Taming Cataclysm
A{"Hyjal", 7525, 0.6100, 0.3300, criterion=21858} -- Brok

-- Pet Battles: The Longest Day
A{"Hyjal", 8348, 0.6100, 0.3300, criterion=23483} -- Brok

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Hyjal", 9069, 0.6140, 0.3280, criterion=26973} -- Brok
...
-- Pet Battles: Taming Northrend
A{"IcecrownGlacier", 6605, 0.7700, 0.2000, criterion=21852} -- Major Payne

-- Pet Battles/Collect: Northrend Tamer
A{"IcecrownGlacier", 6615, criterion=21482} -- Icecrown

-- Pet Battles: The Longest Day
A{"IcecrownGlacier", 8348, 0.7700, 0.2000, criterion=23482} -- Grand Master Payne

-- Pet Battles/Battle: An Awfully Big Adventure
A{"IcecrownGlacier", 9069, 0.7740, 0.1960, criterion=26989} -- Major Payne
...
-- Pet Battles: Taming Pandaria
A{"Krasarang", 6606, 0.6200, 0.4600, criterion=21871} -- Mo'ruk

-- Pet Battles/Collect: Pandaria Tamer
A{"Krasarang", 6616, criterion=21491} -- Krasarang Wilds

-- Pet Battles: The Longest Day
A{"Krasarang", 8348, 0.6200, 0.4600, criterion=23489} -- Grand Master Mo'ruk
A{"Krasarang", 8348, 0.3600, 0.3700, criterion=23499, note="[3 beasts]"} -- Skitterer Xi'a

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Krasarang", 9069, 0.6220, 0.4580, criterion=26990} -- Mo'ruk
...
-- Pet Battles: Taming Pandaria
A{"KunLaiSummit", 6606, 0.3600, 0.7400, criterion=21855} -- Courageous Yon

-- Pet Battles/Collect: Pandaria Tamer
A{"KunLaiSummit", 6616, criterion=21492} -- Kun-Lai Summit

-- Pet Battles: The Longest Day
A{"KunLaiSummit", 8348, 0.3600, 0.7400, criterion=23491} -- Grand Master Yon
A{"KunLaiSummit", 8348, 0.6500, 0.9400, criterion=23496} -- Thundering Pandaren Spirit
A{"KunLaiSummit", 8348, 0.3500, 0.5600, criterion=23498, note="[4 beasts]"} -- Kafi
A{"KunLaiSummit", 8348, 0.6800, 0.8500, criterion=23498, note="[4 beasts]"} -- Dos-Ryga

-- Pet Battles/Battle: An Awfully Big Adventure
A{"KunLaiSummit", 9069, 0.3580, 0.7360, criterion=26977} -- Courageous Yon
A{"KunLaiSummit", 9069, 0.6480, 0.9360, criterion=27005} -- Thundering Pandaren Spirit
A{"LakeWintergrasp", 9069, 0.6560, 0.6440, criterion=27000} -- Stone Cold Trixxy
...
-- Pet Battles: Taming Kalimdor
A{"Moonglade", 6602, 0.4600, 0.6000, criterion=21408, side="horde"} -- Elena Flutterfly

-- Pet Battles: The Longest Day
A{"Moonglade", 8348, 0.4600, 0.6000, criterion=23466} -- Elena Flutterfly
...
-- Pet Battles: Taming Outland
A{"Nagrand", 6604, 0.6100, 0.4900, criterion=21606} -- Narrok

-- Pet Battles/Collect: Outland Tamer
A{"Nagrand", 6614, criterion=21470} -- Nagrand

-- Pet Battles: The Longest Day
A{"Nagrand", 8348, 0.6100, 0.4900, criterion=23472} -- Narrok

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Nagrand", 9069, 0.6100, 0.4940, criterion=26992} -- Narrok
A{"NagrandDraenor", 9069, 0.5620, 0.9800, criterion=27004} -- Tarr the Terrible

-- Pet Battles/Collect: Draenor Safari
A{"NagrandDraenor", 9685, criterion=27246, note="zone exclusive"} -- Leatherhide Runt

-- Pet Battles: Taming Draenor
A{"NagrandDraenor", 9724, 0.5600, 0.1000, criterion=27015} -- Tarr the Terrible
...
-- Pet Battles/Collect: Crazy for Cats
A{"Netherstorm", 8397, 0.4300, 0.3500, criterion=23591, note="from Dealer Rashaad"} -- Siamese Cat
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"Redridge", 6586, 0.1800, 0.6200, criterion=21517} -- Roach
A{"Redridge", 6586, 0.1800, 0.6200, criterion=21663, note="zone exclusive"} -- Mountain Cottontail
A{"Redridge", 6586, 0.2500, 0.2300, criterion=21662, note="zone exclusive"} -- Fledgling Buzzard
A{"Redridge", 6586, 0.3800, 0.6700, criterion=21664, note="zone exclusive\nall around Lakeridge Highway"} -- Redridge Rat

-- Pet Battles: Taming Eastern Kingdoms
A{"Redridge", 6603, 0.3300, 0.5300, criterion=21398, note="opposite the Flight Master, Pet Level: 5", side="alliance"} -- Lindsay

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"Redridge", 6613, criterion=21385} -- Redridge Mountains

-- Pet Battles: The Longest Day
A{"Redridge", 8348, 0.3300, 0.5300, criterion=23420} -- Lindsay
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"SearingGorge", 6586, 0.6500, 0.5800, criterion=21621} -- Fire Beetle
A{"SearingGorge", 6586, 0.4800, 0.5200, criterion=21627} -- Lava Crab
A{"SearingGorge", 6586, 0.6000, 0.7100, criterion=21665} -- Ash Spiderling
...
-- Pet Battles: Taming Eastern Kingdoms
A{"SearingGorge", 6603, 0.3500, 0.2800, criterion=21600, note="Pet Level: 15", side="alliance"} -- Kortas Darkhammer

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"SearingGorge", 6613, criterion=21442} -- Searing Gorge

-- Pet Battles: The Longest Day
A{"SearingGorge", 8348, 0.3500, 0.2800, criterion=23449} -- Kortas Darkhammer
...
-- Pet Battles: Taming Outland
A{"ShadowmoonValley", 6604, 0.3000, 0.4200, criterion=21847} -- Bloodknight Antari

-- Pet Battles/Collect: Outland Tamer
A{"ShadowmoonValley", 6614, criterion=21472} -- Shadowmoon Valley

-- Pet Battles: The Longest Day
A{"ShadowmoonValley", 8348, 0.3000, 0.4200, criterion=23475} -- Grand Master Antari

-- Pet Battles/Battle: An Awfully Big Adventure
A{"ShadowmoonValley", 9069, 0.3040, 0.4180, criterion=27471} -- Bloodknight Antari
A{"ShadowmoonValleyDR", 9069, 0.5000, 0.3100, criterion=26969} -- Ashlei
...
-- Pet Battles: Taming Draenor
A{"ShadowmoonValleyDR", 9724, 0.5000, 0.3100, criterion=27012} -- Ashlei

-- Pet Battles: Taming Outland
A{"ShattrathCity", 6604, 0.5900, 0.7000, criterion=21607} -- Morulu the Elder

-- Pet Battles: The Longest Day
A{"ShattrathCity", 8348, 0.5900, 0.7000, criterion=23470} -- Morulu The Elder

-- Pet Battles/Battle: An Awfully Big Adventure
A{"ShattrathCity", 9069, 0.5900, 0.7000, criterion=26991} -- Morulu the Elder
...
A{"Silithus", 6585, 0.3600, 0.8100, criterion=21740, note="zone exclusive"} -- Scarab Hatchling
...
-- Pet Battles: Taming Kalimdor
A{"SouthernBarrens", 6602, 0.4000, 0.7900, criterion=21409, side="horde"} -- Cassandra Kaboom

-- Pet Battles/Collect: Kalimdor Tamer
A{"SouthernBarrens", 6612, criterion=21462} -- Southern Barrens

-- Pet Battles: The Longest Day
A{"SouthernBarrens", 8348, 0.4000, 0.7900, criterion=23460} -- Cassandra Kaboom

-- Pet Battles/Battle: An Awfully Big Adventure
A{"SpiresOfArak", 9069, 0.4620, 0.4540, criterion=27006} -- Vesharr
...
-- Pet Battles: Taming Draenor
A{"SpiresOfArak", 9724, 0.4600, 0.4500, criterion=27014} -- Vesharr
...
-- Pet Battles/Collect: Kalimdor Safari
A{"StonetalonMountains", 6585, 0.4100, 0.4500, criterion=21743, note="zone exclusive"} -- Coral Snake
A{"StonetalonMountains", 6585, 0.5700, 0.7200, criterion=21744, note="zone exclusive"} -- Venomspitter Hatchling

-- Pet Battles: Taming Kalimdor
A{"StonetalonMountains", 6602, 0.6000, 0.7100, criterion=21405, side="horde"} -- Zonya the Sadist

-- Pet Battles/Collect: Kalimdor Tamer
A{"StonetalonMountains", 6612, criterion=21463} -- Stonetalon Mountains

-- Pet Battles: The Longest Day
A{"StonetalonMountains", 8348, 0.6000, 0.7100, criterion=23457} -- Zonya the Sadist
...
A{"StormwindCity", 9643, 0.5800, 0.5200, criterion="Alliance Balloon", item="54539"} -- Alliance Balloon
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"StranglethornJungle", 6586, 0.5900, 0.2000, criterion=21615} -- Beetle
A{"StranglethornJungle", 6586, 0.5900, 0.2000, criterion=21655} -- Forest Spiderling
A{"StranglethornJungle", 6586, 0.5900, 0.2000, criterion=21656} -- Lizard Hatchling
A{"StranglethornJungle", 6586, 0.5900, 0.2000, criterion=21658, note="zone exclusive"} -- Polly
A{"StranglethornJungle", 6586, 0.5200, 0.3500, criterion=21659} -- Strand Crab
A{"StranglethornJungle", 6586, 0.4400, 0.2300, criterion=21660} -- Tree Python
...
-- Pet Battles: Taming Eastern Kingdoms
A{"StranglethornJungle", 6603, 0.4600, 0.4000, criterion=21400, note="Between Gromgol & Venture Co [Pet Level: 9]", side="alliance"} -- Steven Lisbane

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"StranglethornJungle", 6613, criterion=21441} -- Northern Stranglethorn

-- Pet Battles: The Longest Day
A{"StranglethornJungle", 8348, 0.4600, 0.4000, criterion=23446} -- Steven Lisbane
...
A{"StranglethornJungle", 9643, 0.4200, 0.4000, criterion="Crimson Moth"} -- Crimson Moth
...
A{"StranglethornJungle", 9643, 0.4700, 0.1100, criterion="Lashtail Hatchling", item="52894", note="from Brother Nimitz quest Bad Medicine"} -- Lashtail Hatchling
A{"StranglethornJungle", 9643, 0.5100, 0.6500, criterion="Panther Cub", item="52226", note="from Brother Nimitz quest Some Good Will Come"} -- Panther Cub
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"SwampOfSorrows", 6586, 0.8600, 0.2400, criterion=21649} -- Huge Toad
A{"SwampOfSorrows", 6586, 0.6900, 0.7400, criterion=21657} -- Parrot
A{"SwampOfSorrows", 6586, 0.8300, 0.3900, criterion=21671, note="zone exclusive"} -- Moccasin
A{"SwampOfSorrows", 6586, 0.8600, 0.2400, criterion=21672, note="zone exclusive\noften found as a secondary pet"} -- Swamp Moth

-- Pet Battles: Taming Eastern Kingdoms
A{"SwampOfSorrows", 6603, 0.7700, 0.4100, criterion=21601, note="Pet Level: 16", side="alliance"} -- Everessa

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"SwampOfSorrows", 6613, criterion=21444} -- Swamp of Sorrows

-- Pet Battles: The Longest Day
A{"SwampOfSorrows", 8348, 0.7700, 0.4100, criterion=23450} -- Everessa

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Talador", 9069, 0.4900, 0.8040, criterion=27002} -- Taralune
...
-- Pet Battles: Taming Draenor
A{"Talador", 9724, 0.4900, 0.8000, criterion=27016} -- Taralune

-- Pet Battles/Battle: Tiny Terrors in Tanaan
A{"TanaanJungle", 10052, 0.2600, 0.3200, criterion=28796} -- Felsworn Sentry
A{"TanaanJungle", 10052, 0.5300, 0.6500, criterion=28797} -- Corrupted Thundertail
A{"TanaanJungle", 10052, 0.2700, 0.7100, criterion=28798, note="in cave"} -- Chaos Pup
A{"TanaanJungle", 10052, 0.3100, 0.3800, criterion=28799} -- Cursed Spirit
A{"TanaanJungle", 10052, 0.5600, 0.8100, criterion=28800} -- Felfly
A{"TanaanJungle", 10052, 0.4300, 0.8500, criterion=28801} -- Tainted Maulclaw
A{"TanaanJungle", 10052, 0.5800, 0.3700, criterion=28802} -- Direflame
A{"TanaanJungle", 10052, 0.4200, 0.7200, criterion=28803} -- Mirecroak
A{"TanaanJungle", 10052, 0.5400, 0.3000, criterion=28804} -- Dark Gazer
A{"TanaanJungle", 10052, 0.1600, 0.4500, criterion=28805} -- Bleakclaw
A{"TanaanJungle", 10052, 0.4400, 0.4600, criterion=28806} -- Vile Blood of Draenor
A{"TanaanJungle", 10052, 0.4600, 0.5300, criterion=28807} -- Dreadwalker
A{"TanaanJungle", 10052, 0.4800, 0.3600, criterion=28810} -- Netherfist
A{"TanaanJungle", 10052, 0.4900, 0.3100, criterion=28808} -- Skrillix
A{"TanaanJungle", 10052, 0.7500, 0.3700, criterion=28809} -- Defiled Earth
...
A{"TheCapeOfStranglethorn", 6586, 0.4280, 0.7160, criterion=21670} -- Wharf Rat

-- Pet Battles: Taming Eastern Kingdoms
A{"TheCapeOfStranglethorn", 6603, 0.5100, 0.7300, criterion=21401, note="near the path from Booty Bay. Pet Level 11", side="alliance"} -- Bill Buckler

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"TheCapeOfStranglethorn", 6613, criterion=21427} -- Cape of Stranglethorn

-- Pet Battles: The Longest Day
A{"TheCapeOfStranglethorn", 8348, 0.5150, 0.7340, criterion=23445} -- Bill Buckler

-- Pet Battles/Collect: So. Many. Pets.
A{"TheCapeOfStranglethorn", 9643, 0.4200, 0.6900, criterion="Parrot Cage (Cockatiel)", item="7390", note="from Narkk"} -- Parrot Cage (Cockatiel)
A{"TheCapeOfStranglethorn", 9643, 0.4200, 0.6900, criterion="Parrot Cage (Senegal)", item="7389", note="from Narkk"} -- Parrot Cage (Senegal)
...
-- Pet Battles: Taming Pandaria
A{"TheJadeForest", 6606, 0.4800, 0.5400, criterion=21853} -- Hyuna of the Shrines

-- Pet Battles/Collect: Pandaria Tamer
A{"TheJadeForest", 6616, criterion=21489} -- Jade Forest

-- Pet Battles: The Longest Day
A{"TheJadeForest", 8348, 0.4800, 0.5400, criterion=23488} -- Grand Master Hyuna
A{"TheJadeForest", 8348, 0.2900, 0.3600, criterion=23497} -- Whispering Pandaren Spirit
A{"TheJadeForest", 8348, 0.4800, 0.7100, criterion=23498, note="[4 beasts]"} -- Ka'wi the Gorger
A{"TheJadeForest", 8348, 0.5700, 0.2900, criterion=23498, note="[4 beasts]"} -- Nitun

-- Pet Battles/Battle: An Awfully Big Adventure
A{"TheJadeForest", 9069, 0.4800, 0.5400, criterion=26985} -- Hyuna of the Shrines
A{"TheJadeForest", 9069, 0.2880, 0.3600, criterion=27008} -- Whispering Pandaren Spirit
...
-- Pet Battles/Collect: Kalimdor Safari
A{"ThousandNeedles", 6585, 0.3300, 0.6000, criterion=21749, note="zone exclusive"} -- Twilight Iguana

-- Pet Battles: Taming Kalimdor
A{"ThousandNeedles", 6602, 0.3200, 0.3300, criterion=21416, side="horde"} -- Kela Grimtotem

-- Pet Battles/Collect: Kalimdor Tamer
A{"ThousandNeedles", 6612, criterion=21465} -- Thousand Needles

-- Pet Battles: The Longest Day
A{"ThousandNeedles", 8348, 0.3200, 0.3300, criterion=23462} -- Kela Grimtotem
...
A{"TimelessIsle", 8519, 0.3500, 0.6000, criterion=23600} -- Xu-Fu, Cub of Xuen
A{"TimelessIsle", 8519, 0.3500, 0.6100, criterion=23719} -- Chi-Chi, Hatchling of Chi-Ji
A{"TimelessIsle", 8519, 0.3500, 0.6200, criterion=23720} -- Yu'la, Broodling of Yu'lon
A{"TimelessIsle", 8519, 0.3500, 0.6300, criterion=23721} -- Zao, Calfling of Niuzao

-- Pet Battles/Battle: An Awfully Big Adventure
A{"TimelessIsle", 9069, 0.4020, 0.5640, criterion=26971} -- Blingtron 4000
A{"TimelessIsle", 9069, criterion=26975} -- Chen Stormstout
A{"TimelessIsle", 9069, 0.4020, 0.5620, criterion=26979} -- Dr. Ion Goldbloom
A{"TimelessIsle", 9069, 0.4000, 0.5260, criterion=26987} -- Lorewalker Cho
A{"TimelessIsle", 9069, 0.3780, 0.5720, criterion=26999} -- Shademaster Kiryn
A{"TimelessIsle", 9069, 0.3780, 0.5720, criterion=27001} -- Sully "The Pickle" McLeary
A{"TimelessIsle", 9069, 0.4000, 0.5260, criterion=27003} -- Taran Zhu
A{"TimelessIsle", 9069, 0.4000, 0.5260, criterion=27009} -- Wise Mari
A{"TimelessIsle", 9069, 0.3780, 0.5720, criterion=27010} -- Wrathion
...
-- Pet Battles: Taming Pandaria
A{"TownlongWastes", 6606, 0.3600, 0.5200, criterion=21870} -- Seeker Zusshi

-- Pet Battles/Collect: Pandaria Tamer
A{"TownlongWastes", 6616, criterion=21493} -- Townlong Steppes

-- Pet Battles: The Longest Day
A{"TownlongWastes", 8348, 0.3600, 0.5200, criterion=23487} -- Grand Master Zusshi
A{"TownlongWastes", 8348, 0.5700, 0.4200, criterion=23495} -- Burning Pandaren Spirit
A{"TownlongWastes", 8348, 0.7200, 0.8000, criterion=23500, note="[3 beasts]"} -- Ti'un the Wanderer

-- Pet Battles/Battle: An Awfully Big Adventure
A{"TownlongWastes", 9069, 0.5700, 0.4220, criterion=26974} -- Burning Pandaren Spirit
A{"TownlongWastes", 9069, 0.3620, 0.5220, criterion=26998} -- Seeker Zusshi
...
-- Pet Battles: Taming Cataclysm
A{"TwilightHighlands", 7525, 0.5700, 0.5700, criterion=21860} -- Goz Banefury

-- Pet Battles: The Longest Day
A{"TwilightHighlands", 8348, 0.5700, 0.5700, criterion=23485} -- Goz Banefury

-- Pet Battles/Battle: An Awfully Big Adventure
A{"TwilightHighlands", 9069, 0.5660, 0.5680, criterion=26983} -- Goz Banefury
...
A{"Uldum", 6585, 0.5800, 0.5200, criterion=21752, note="zone exclusive"} -- Locust
A{"Uldum", 6585, 0.5800, 0.5300, criterion=21753, note="zone exclusive"} -- Mac Frog
A{"Uldum", 6585, 0.6200, 0.3900, criterion=21754, note="zone exclusive"} -- Oasis Moth
A{"Uldum", 6585, 0.4100, 0.4500, criterion=21755, note="zone exclusive"} -- Tol'vir Scarab

-- Pet Battles/Collect: Kalimdor Tamer
A{"Uldum", 6612, criterion=21487} -- Uldum

-- Pet Battles: Taming Cataclysm
A{"Uldum", 7525, 0.5700, 0.4200, criterion=21861} -- Obalis

-- Pet Battles: The Longest Day
A{"Uldum", 8348, 0.5700, 0.4200, criterion=23486} -- Grand Master Obalis

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Uldum", 9069, 0.5660, 0.4180, criterion=26995} -- Obalis
...
-- Pet Battles/Collect: Crazy for Cats
A{"Undercity", 8397, 0.6800, 0.0700, criterion=23584, note="from Chub during Hallow's End"} -- Feline Familiar
...
-- Pet Battles/Collect: Kalimdor Safari
A{"UngoroCrater", 6585, 0.3500, 0.6600, criterion=21750, note="zone exclusive"} -- Diemetradon Hatchling
...
-- Pet Battles: Taming Pandaria
A{"ValeOfEternalBlossomsScenario", 6606, 0.3100, 0.7400, criterion=21857} -- Aki the Chosen

-- Pet Battles/Collect: Pandaria Tamer
A{"ValeOfEternalBlossomsScenario", 6616, criterion=21495} -- Vale of Eternal Blossoms

-- Pet Battles: The Longest Day
A{"ValeOfEternalBlossomsScenario", 8348, 0.3100, 0.7400, criterion=23493} -- Grand Master Aki
A{"ValeOfEternalBlossomsScenario", 8348, 0.1100, 0.7100, criterion=23500, note="[3 beasts]"} -- No-No

-- Pet Battles/Battle: An Awfully Big Adventure
A{"ValeOfEternalBlossomsScenario", 9069, 0.3120, 0.7420, criterion=25118} -- Aki the Chosen
...
-- Pet Battles: Taming Pandaria
A{"ValleyoftheFourWinds", 6606, 0.4600, 0.4400, criterion=21854} -- Farmer Nishi

-- Pet Battles/Collect: Pandaria Tamer
A{"ValleyoftheFourWinds", 6616, criterion=21490} -- Valley of the Four Winds

-- Pet Battles: The Longest Day
A{"ValleyoftheFourWinds", 8348, 0.4600, 0.4400, criterion=23490} -- Grand Master Nishi
A{"ValleyoftheFourWinds", 8348, 0.2500, 0.7900, criterion=23499, note="[3 beasts]"} -- Greyhoof
A{"ValleyoftheFourWinds", 8348, 0.4100, 0.4400, criterion=23499, note="[3 beasts]"} -- Lucky Yi

-- Pet Battles/Battle: An Awfully Big Adventure
A{"ValleyoftheFourWinds", 9069, 0.4600, 0.4360, criterion=26980} -- Farmer Nishi
...
-- Pet Battles/Collect: So. Many. Pets.
A{"WesternPlaguelands", 9643, 0.4400, 0.6800, criterion="Blighthawk", item="61826", note="zone exclusive"} -- Blighthawk
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"Westfall", 6586, 0.5800, 0.1700, criterion=21519} -- Snake
A{"Westfall", 6586, 0.5400, 0.3100, criterion=21687, note="zone exclusive"} -- Tiny Harvester

-- Pet Battles: Taming Eastern Kingdoms
A{"Westfall", 6603, 0.6100, 0.1900, criterion=21397, note="Main road Pet Level: 3", side="alliance"} -- Old MacDonald

-- Pet Battles/Collect: Eastern Kingdoms Tamer
A{"Westfall", 6613, criterion=21384} -- Westfall

-- Pet Battles: The Longest Day
A{"Westfall", 8348, 0.6100, 0.1900, criterion=23419} -- Old MacDonald
...
-- Pet Battles/Collect: Eastern Kingdoms Safari
A{"Wetlands", 6586, 0.6900, 0.2900, criterion=21625, note="inside the cave"} -- Cockroach
A{"Wetlands", 6586, 0.6000, 0.5600, criterion=21646} -- Toad
A{"Wetlands", 6586, 0.6000, 0.5600, criterion=21661} -- Water Snake
...
A{"Wetlands", 9643, 0.6900, 0.2900, criterion="Razormaw Hatchling", item="35398"} -- Razormaw Hatchling
...
-- Pet Battles/Collect: Kalimdor Safari
A{"Winterspring", 6585, 0.5100, 0.5600, criterion=21512, note="zone exclusive"} -- Crystal Spider
A{"Winterspring", 6585, criterion=21757, note="zone exclusive"} -- Snowy Owl

-- Pet Battles: Taming Kalimdor
A{"Winterspring", 6602, 0.6600, 0.6400, criterion=21415, side="horde"} -- Stone Cold Trixxy

-- Pet Battles/Collect: Kalimdor Tamer
A{"Winterspring", 6612, criterion=21467} -- Winterspring

-- Pet Battles: The Longest Day
A{"Winterspring", 8348, 0.6600, 0.6400, criterion=23453} -- Grand Master Trixxy

-- Pet Battles/Collect: Crazy for Cats
A{"Winterspring", 8397, 0.6000, 0.5200, criterion=23595, note="from Michelle De Rum"} -- Winterspring Cub
...
-- Pet Battles: Taming Outland
A{"Zangarmarsh", 6604, 0.1700, 0.5000, criterion=21605} -- Ras'an

-- Pet Battles/Collect: Outland Tamer
A{"Zangarmarsh", 6614, criterion=21476} -- Zangarmarsh

-- Pet Battles: The Longest Day
A{"Zangarmarsh", 8348, 0.1700, 0.5000, criterion=23469} -- Ras'an

-- Pet Battles/Battle: An Awfully Big Adventure
A{"Zangarmarsh", 9069, 0.1720, 0.5040, criterion=26997} -- Ras'an
...
-- Pet Battles: Taming Northrend
A{"ZulDrak", 6605, 0.1300, 0.6700, criterion=21851} -- Gutretch

-- Pet Battles/Collect: Northrend Tamer
A{"ZulDrak", 6615, criterion=21485} -- Zul'Drak

-- Pet Battles: The Longest Day
A{"ZulDrak", 8348, 0.1300, 0.6700, criterion=23478} -- Gutretch

-- Pet Battles/Battle: An Awfully Big Adventure
A{"ZulDrak", 9069, 0.1320, 0.6680, criterion=26984} -- Gutretch
